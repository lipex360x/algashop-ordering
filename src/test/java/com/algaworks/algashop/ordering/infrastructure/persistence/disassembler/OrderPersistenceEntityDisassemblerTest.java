...
class OrderPersistenceEntityDisassemblerTest {
  ...
  void shouldConvertFromPersistence() {
    OrderPersistenceEntity persistenceEntity = OrderPersistenceEntityDataBuilder.existing().build();
    ...
    assertThat(domainEntity).satisfies(
      ...
      s -> assertThat(s.cancelledAt()).isEqualTo(persistenceEntity.getCancelledAt()),
